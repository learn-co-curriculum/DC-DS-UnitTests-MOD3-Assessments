...
# 1.  Compute the descriptive statistics of check totals.
...
# 2. Calculate the 95% confidence interval around the mean check total and interpret it correctly. 
...
# 3. Using a z-test and an $\alpha = 0.05$, is my 23 dollar check significantly **greater** than the mean in our sample? How do you know this?
...
# 4.  According to the results of the statistical test above explain the decision you would make regarding your null hypothesis and why you made that decision.
